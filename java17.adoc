...
Ils utilisent des mappers pour s’échanger le concept de `Document` à l’aide de https://en.wikipedia.org/wiki/Data_transfer_object[DTO]s, envoyés en http (microservices) ou en runtime (monolith modulaire). +
...
* le https://en.wikipedia.org/wiki/Visitor_pattern#Sources_3[visitor pattern]
